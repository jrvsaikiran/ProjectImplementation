...
public class TC008 extends GenericWrappers{
	...
	public void bookRoomsWithGst() {
		...
		waitTime(3000);		
		enterByName("firstName", "kiran");		
		enterByName("lastName", "sai");		
		...
		enterByName("gstNumber", "abcdeffh234");		
		enterByName("companyName", "jrv groups");		
		enterByName("companyAddress", "chennai");		
